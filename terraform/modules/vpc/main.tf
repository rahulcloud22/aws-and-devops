...
#Even if you know the public IP, traffic still must pass through AWS’s Internet Gateway because it is the controlled boundary between the public internet and the private VPC network.
